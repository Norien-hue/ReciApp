...
Este documento explica paso a paso como obtener cada una de las 18 capturas
...
1. Arranca la app movil: `npx expo start` y abrela en tu movil con Expo Go
   o en un emulador.
...
2. **Opcion B (modo avion):** Pon el movil en modo avion y abre la app.
...
## Captura #14 — JavaFX: Grafico de emisiones

**Seccion del documento:** 9. Aplicacion de Escritorio

**Como hacerla:**

1. Ve a la tercera pestana del dashboard (grafico de emisiones).
2. Debe mostrarse un grafico de barras con las emisiones reducidas por
   cada usuario.
3. Si solo hay un usuario, crea un par mas desde la pestana de admin para
   que el grafico sea mas visual.
4. Captura la ventana.

---

## Captura #15 — JavaFX: Dialogo Crear/Modificar Producto
...
## Captura #16 — Terminal: Banner y autenticacion
...
## Captura #17 — Terminal: Flujo completo de reciclaje
...
## Captura #18 — Consola EC2 con la API en ejecucion
...
| 5  | Movil - Login                           | Expo Go / Emulador          |
| 6  | Movil - Productos filtrados             | Expo Go / Emulador          |
| 7  | Movil - Historial                       | Expo Go / Emulador          |
| 8  | Movil - Perfil                          | Expo Go / Emulador          |
| 9  | Movil - Modal offline                   | Expo Go / Emulador          |
...
| 14 | JavaFX - Grafico emisiones              | App escritorio (admin)      |
| 15 | JavaFX - Dialogo producto               | App escritorio (admin)      |
| 16 | Terminal - Banner                       | Python + terminal           |
| 17 | Terminal - Reciclaje completo           | Python + terminal           |
| 18 | EC2 - API corriendo                     | SSH a EC2                   |
